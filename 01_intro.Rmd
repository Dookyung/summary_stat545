...
knitr::include_graphics("diagrams/Rmarkdown.png")
```

```{r echo = FALSE, out.width = "75%"}
knitr::include_graphics("diagrams/Markdown.png")
```

```{r echo = FALSE, out.width = "75%"}
knitr::include_graphics("diagrams/html.png")
```
...
```{r echo = FALSE, out.width = "75%"}
knitr::include_graphics("diagrams/git_finaldoc.png")
```
...
```{r echo = FALSE, out.width = "75%"}
knitr::include_graphics("diagrams/make.png")
```


```{r echo = FALSE, out.width = "75%"}
knitr::include_graphics("diagrams/make2.png")
```
...
```{r echo = FALSE, out.width = "75%"}
knitr::include_graphics("diagrams/datascience.png")
```


```{r echo = FALSE, out.width = "75%"}
knitr::include_graphics("diagrams/dsskill.png")
```

https://gist.github.com/hadley/820f09ded347c62c2864

```{r echo = FALSE, out.width = "75%"}
knitr::include_graphics("diagrams/dsworkflow.png")
```


```{r echo = FALSE, out.width = "75%"}
knitr::include_graphics("diagrams/bigdata.png")
```


```{r echo = FALSE, out.width = "75%"}
knitr::include_graphics("diagrams/3d.png")
```
